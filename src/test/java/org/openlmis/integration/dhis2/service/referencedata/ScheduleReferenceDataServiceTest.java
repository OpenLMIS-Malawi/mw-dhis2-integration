...
import org.openlmis.integration.dhis2.service.BaseCommunicationService;
import org.openlmis.integration.dhis2.service.BaseCommunicationServiceTest;

@RunWith(MockitoJUnitRunner.class)
public class ScheduleReferenceDataServiceTest
    extends BaseCommunicationServiceTest<ProcessingScheduleDto> {
  ...
  @Test
  public void shouldSearchProcessingSchedulesByProgramAndFacilityIds() {
    // given
    UUID programId = UUID.randomUUID();
    UUID facilityId = UUID.randomUUID();

    // when
    ProcessingScheduleDto schedule = mockPageResponseEntityAndGetDto();
    Collection<ProcessingScheduleDto> result = service.search(programId, facilityId);
